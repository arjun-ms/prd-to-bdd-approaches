# -*- coding: utf-8 -*-
"""
PRD to BDD Converter - Approach 1: Cosine Similarity (80% Threshold)
Author: Arjun M S
Approach: Uses cosine similarity with 80% threshold and predefined contrast pairs
"""
...
# ==========================================================
# DEDUPLICATION: APPROACH 1 - COSINE SIMILARITY (80%)
# ==========================================================

def remove_duplicates_cosine_80(features, threshold=0.8, show_duplicates=True):
    """
    Remove semantically similar BDD scenarios using cosine similarity 
    with 80% threshold and contrast pair detection.
    ...
    if show_duplicates and duplicates:
        ...
        pd.DataFrame(dup_data).to_csv("duplicates_report_80.csv", index=False, encoding="utf-8")
        print("\n📊 Detailed duplicate report saved → duplicates_report_80.csv")
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("APPROACH 1: COSINE SIMILARITY (80% THRESHOLD)")
    print("=" * 60)
    ...
    raw_output_path = Path("bdd_output_raw_approach1.json")
    ...
    # Remove duplicates using 80% threshold
    ...
    deduped_output_path = Path("bdd_output_deduped_approach1.json")
